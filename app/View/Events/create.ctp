...
echo $this->Form->input("Event.group_id",
		array('label' => "グループ", 'options' => $groupList, 'empty' => true)
	);
echo $this->Form->input("Event.name", array('label' => "イベント名"));
echo $this->Form->input("Event.description", array('label' => "イベントの説明"));
?>
